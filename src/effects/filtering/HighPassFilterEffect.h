...
public:
    static constexpr const char *TYPE_ID = "highpass"; ///< Stable type identifier used by EffectFactory and PresetManager.
...
protected:
    /**
     * Applies the first 'order' cascaded high-pass stages at the current cutoff frequency.
    ...
    /**
     * Configures all k_maxStages filters as high-pass and prepares each one.
